...
camera_set_view_size(view_camera[0], 1024, 768); //See common resolution sizes above.
...
scr_CRT_init_shader(view_camera[0], true, 0.12, true, true, false, 0.03, 80.0, 1.0, false, 0.175);